...
# Set ngrok authtoken
Start-Process -FilePath "C:\ngrok\ngrok.exe" -ArgumentList "authtoken", "2C9Jq1pXMHvQtbIOkHFLMIM1ep1_4w6Yia5gi7BVJZeahCXPn" -Wait | Out-Null
...
# Run ngrok with specified parameters and hide the window
