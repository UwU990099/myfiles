...
Write-Host -NoNewline "Group policies importing..."
...
# Import GP
& "C:\LGPO\LGPO.exe" /g "C:\gp" | Out-Null

Write-Host "`rGroup policies imported.         "

Write-Host -NoNewline "Remote desktop enabling..."
...
Write-Host "`rRemote desktop enabled.       "

Write-Host -NoNewline "Desktop wallpaper changing..."
...
Write-Host "`rDesktop wallpaper changed.       "
Write-Host -NoNewline "Audio enabling..."
